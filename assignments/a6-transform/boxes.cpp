...
public:
   ...
   void scene()
   {
      ...
      // Question 1 - B2
      vec3 d20 = vec3(4, 0, 2);
      float angleInRad = 45 * atkmath::PI / 180;
      quat R20 = glm::angleAxis(angleInRad, vec3(0,0,1));
      ...
      // Question 1 - B3
      vec3 d30 = vec3(5, 4, 2);
      angleInRad = 90 * atkmath::PI / 180;
      quat R30 = glm::angleAxis(angleInRad, vec3(0,0,1));
      ...
      Transform F = transform * F10 * F20.inverse();
